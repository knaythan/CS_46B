...
public class FamilyTree {
    ...
    private static class TreeNode<T> {
        ...
        TreeNode<T> getNodeWithName(String targetName) {
            ...
            if (this.data.equals(targetName)) return this;
                // No, recurse. Check all children of this node.
                for (TreeNode child : children) {
                    // If child.getNodeWithName(targetName) returns a non-null node,
                    // then that's the node we're looking for. Return it.
                    TreeNode<T> targetNode = child.getNodeWithName(targetName);
            ...
            ArrayList<TreeNode<T>> collectAncestorsToList() {
                ...
                TreeNode<T> ancestor = this.parent;
                while (ancestor != null) {
		 ...
		 */
            ...
            if (root == null)
                ...
                if (parentNode == null) throw new TreeException("something wrong in the data file");
            }
		...
		*/
        ...
        TreeNode<String> getMostRecentCommonAncestor(String name1, String name2) throws TreeException {
            ...
            if (node2 == null)
                throw new TreeException("invalid name2");
...
//            System.out.println("Most recent common ancestor of Bilbo and Frodo is " + ancestor.getData());
                TreeNode<String> ancestor = tree.getMostRecentCommonAncestor("Nathan", "Rod");
                System.out.println("Most recent common ancestor of Nathan and Rod is " + ancestor.getData());
            } catch (IOException x) {
